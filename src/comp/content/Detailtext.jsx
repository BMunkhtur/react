          ...
          </div>
          {
            Detailtexth.map((Detailtexth, index) =>(
                <div key={index}>
                        ...
                        <p className="detailtext">{Detailtexth.text}</p>
                </div>
            ))}
    </div>
    )
